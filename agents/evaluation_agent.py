...
class EvaluationAgent(BaseAgent):
    ...
    async def execute(
        ...
        try:
            ...
            if task_type == "classification":
                result = self._evaluate_classification(y_test, y_pred)
            else:
                result = self._evaluate_regression(y_test, y_pred)
    ...
    def _evaluate_classification(self, y_test: Any, y_pred: Any) -> dict[str, Any]:
    ...
    def _evaluate_regression(self, y_test: Any, y_pred: Any) -> dict[str, Any]:
